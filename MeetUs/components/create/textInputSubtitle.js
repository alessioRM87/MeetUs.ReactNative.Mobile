...
import { setSubtitle } from '../../actions/actionEvents';

class TextInputSubtitle extends React.Component{

    constructor(props){
        super(props);
    }

    handleOnChangeText(subtitle){
    ...
    render(){
        return (
            <View style={styles.main}>
                ...
                <Text
                    style={styles.textError}>{this.props.subtitleError}</Text> 
            </View>
        );
    }
}
